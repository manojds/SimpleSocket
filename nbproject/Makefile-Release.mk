...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/simplesocket
...
${OBJECTDIR}/src/LogFactory.o: src/LogFactory.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/LogFactory.o src/LogFactory.cpp

${OBJECTDIR}/src/SimpleSocket.o: src/SimpleSocket.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/SimpleSocket.o src/SimpleSocket.cpp
...
${OBJECTDIR}/test/ErrorConditionTests.o: test/ErrorConditionTests.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/test/ErrorConditionTests.o test/ErrorConditionTests.cpp
...
${OBJECTDIR}/test/TestUtils.o: test/TestUtils.cpp
	${MKDIR} -p ${OBJECTDIR}/test
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/test/TestUtils.o test/TestUtils.cpp
